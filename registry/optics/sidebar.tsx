...
type SidebarRender = Parameters<typeof useRender>[0]["render"];
...
type SidebarMenuButtonVariant = VariantProps<
	typeof sidebarMenuButtonVariants
>["variant"];
type SidebarMenuButtonSize = VariantProps<
	typeof sidebarMenuButtonVariants
>["size"];
type SidebarMenuButtonVariantValue = Exclude<SidebarMenuButtonVariant, null>;
type SidebarMenuButtonSizeValue = Exclude<SidebarMenuButtonSize, null>;

function SidebarMenuButton({
	render = undefined,
	isActive = false,
	variant = "default" as SidebarMenuButtonVariantValue,
	size = "default" as SidebarMenuButtonSizeValue,
	tooltip = undefined,
	className = "",
	...props
