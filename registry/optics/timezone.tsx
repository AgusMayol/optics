...
type CopiedButton = "user" | "utc" | "relative" | null;
...
function Timezone({
	...
	const [userTimezone, setUserTimezone] = React.useState<string | null>(null);
	...
	const [copiedButton, setCopiedButton] = React.useState<CopiedButton>(null);
	...
	const copyToClipboard = React.useCallback(
		async (text: string, buttonId: NonNullable<CopiedButton>) => {
			if (
				!text ||
				text === "—" ||
				text === "Invalid date" ||
	...
	return (
		<Tooltip open={isOpen} onOpenChange={setIsOpen}>
			<TooltipTrigger
				render={render ?? <Button variant="ghost">Open timezone</Button>}
			/>
			<TooltipContent
				className={cn(
