...
type KbdVariant = "default" | "legacy";

type KbdProps = React.ComponentProps<"kbd"> & {
	variant?: KbdVariant;
	useHotkey?: boolean;
	animate?: boolean;
	onHotkeyPress?: (event: KeyboardEvent) => void;
	hotkey?: string;
};
...
function normalizeHotkeyString(str?: string | null): string | null {
	if (!str) return null;
...
function matchesHotkey(hotkey: string | null, event: KeyboardEvent) {
...
function Kbd({
	...
	const kbdRef = useRef<HTMLElement | null>(null);
