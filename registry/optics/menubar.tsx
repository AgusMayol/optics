...
type MenubarItemVariant = "default" | "destructive";
...
function MenubarTrigger({
	className = "",
	...props
}: Omit<React.ComponentProps<typeof DropdownMenuTrigger>, "className"> & {
	className?: string;
}) {
	return (
		<DropdownMenuTrigger
...
function MenubarContent({
	...
	sideOffset = 8,
	...props
}: Omit<React.ComponentProps<typeof DropdownMenuContent>, "className"> & {
	className?: string;
}) {
	return (
		<DropdownMenuContent
...
function MenubarLabel({
	...
	inset = false,
	...props
}: Omit<React.ComponentProps<typeof DropdownMenuLabel>, "className"> & {
	className?: string;
	inset?: boolean;
}) {
	return (
...
function MenubarSeparator({
	className = "",
	...props
}: Omit<React.ComponentProps<typeof DropdownMenuSeparator>, "className"> & {
	className?: string;
}) {
	return (
		<DropdownMenuSeparator
...
function MenubarSubTrigger({
	...
	inset = false,
	...props
}: Omit<React.ComponentProps<typeof DropdownMenuSubTrigger>, "className"> & {
	className?: string;
	inset?: boolean;
}) {
	return (
...
function MenubarSubContent({
	className = "",
	...props
}: Omit<React.ComponentProps<typeof DropdownMenuSubContent>, "className"> & {
	className?: string;
}) {
	return (
		<DropdownMenuSubContent
