...
type ItemRender = Parameters<typeof useRender>[0]["render"];
...
type ItemTextProps = React.ComponentProps<"div">;
...
function ItemContent({ className = "", ...props }: ItemTextProps) {
	return (
		<div
...
function ItemTitle({ className = "", ...props }: ItemTextProps) {
	return (
		<div
...
function ItemActions({ className = "", ...props }: ItemTextProps) {
	return (
		<div
...
function ItemHeader({ className = "", ...props }: ItemTextProps) {
	return (
		<div
...
function ItemFooter({ className = "", ...props }: ItemTextProps) {
	return (
		<div
