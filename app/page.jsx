		...
		<main className="flex flex-col flex-1 gap-8 bg-background lg:rounded-b-3xl lg:rounded-bl-none">
			...
			<GridContainer cols={4} rows={isMobile ? 10 : 6}>
					<GridItem
						...
						className="w-full rounded-none flex flex-col items-center justify-center px-0 lg:px-12 gap-8"
					>
						...
						>
							...
							>
								<div className="relative -bottom-38 left-0 w-full">
									<h2 className="text-base text-foreground truncate">Typography</h2>
					...
					>
						...
						>
							...
							>
								...
								<div className="w-full">
									<h2 className="text-foreground text-base truncate">Components</h2>
									<p className="text-muted-foreground font-normal truncate">
					...
					>
						...
						>
							...
							>
								...
								<div className="w-full">
									<h2 className="text-base text-foreground truncate">Iconography</h2>
									<p className="text-muted-foreground font-normal truncate">
						...
						>
							...
							>
								...
								<div className="relative -top-2.5 left-0 w-full">
									<h2 className="text-base text-foreground truncate">Animations</h2>
									<p className="text-muted-foreground font-normal truncate">
					...
					>
						...
						>
							...
							>
								<div className="relative -bottom-38 left-0 w-full">
									<h2 className="text-base text-foreground truncate">Security</h2>
									<p className="text-muted-foreground font-normal truncate">
