							...
							>
								<div className="w-full flex flex-col gap-4 mt-4">
									...
									<div className="w-full flex gap-4">
										...
										<Input
											id="homepage-components-email-preview"
											type="email"
											name="email"
											placeholder="Email Address"
											className="flex-1 text-xs placeholder:text-xs pointer-events-none disabled:opacity-100 !bg-background group-hover:!bg-background border-border! bg-clip-padding"
										/>
									</div>
								</div>
