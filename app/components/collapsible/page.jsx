...
const commands = [
	{
		label: "pnpm",
		code: "pnpm dlx shadcn@latest add @optics/collapsible",
	},
	{
		label: "npm",
		code: "npx shadcn@latest add @optics/collapsible",
	},
	{
		label: "yarn",
		code: "yarn shadcn@latest add @optics/collapsible",
	},
	{
		label: "bun",
		code: "bunx --bun shadcn@latest add @optics/collapsible",
	},
];
					...
					<TabsContents className="w-full pt-2">
						...
						>
							<div className="w-full flex flex-col gap-2">
								...
								<CodeBlock
									data={collapsibleComponentCode}
									defaultValue={collapsibleComponentCode[0].filename}
								>
									<CodeBlockHeader>
										<CodeBlockCopyButton
											variant="ghost"
