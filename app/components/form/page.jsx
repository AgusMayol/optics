...
const commands = [
	{
		label: "pnpm",
		code: "pnpm dlx shadcn@latest add @optics/form",
	},
	{
		label: "npm",
		code: "npx shadcn@latest add @optics/form",
	},
	{
		label: "yarn",
		code: "yarn shadcn@latest add @optics/form",
	},
	{
		label: "bun",
		code: "bunx --bun shadcn@latest add @optics/form",
	},
];
					...
					<TabsContents className="w-full pt-2">
						...
						>
							<div className="w-full flex flex-col gap-2">
								...
								<CodeBlock
									data={formComponentCode}
									defaultValue={formComponentCode[0].filename}
								>
									<CodeBlockHeader>
										<CodeBlockCopyButton
											variant="ghost"
					...
					>
						...
						<GridRow>
							...
							<GridItem span={8} className="text-xs font-mono justify-start">
								object (react-hook-form form object)
							</GridItem>
						</GridRow>
					</GridContainer>
				</div>
