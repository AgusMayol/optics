...
const code = [
	{
		...
		code: `<Window>
	<WindowHeader>
		<WindowTitle>Titulo de la tarjeta</WindowTitle>
	</WindowHeader>
	<WindowContent>Contenido de la tarjeta</WindowContent>
	<WindowFooter className="flex items-center justify-end">
	...
	return (
		<main className="min-h-[calc(100vh-128px)] screen flex flex-col flex-1 gap-8 bg-background rounded-b-xl lg:rounded-bl-none">
			<div className="flex flex-col gap-4 p-12 pb-0">
				<h1 className="text-4xl font-bold tracking-tight">Window</h1>
				<p className="text-muted-foreground text-xl">
					Displays a window with header, content, and footer.
				</p>
			</div>
