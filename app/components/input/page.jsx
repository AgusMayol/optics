...
const commands = [
	{
		label: "pnpm",
		code: "pnpm dlx shadcn@latest add @optics/input",
	},
	{
		label: "npm",
		code: "npx shadcn@latest add @optics/input",
	},
	{
		label: "yarn",
		code: "yarn shadcn@latest add @optics/input",
	},
	{
		label: "bun",
		code: "bunx --bun shadcn@latest add @optics/input",
	},
];
		...
		<main className="min-h-[calc(100vh-128px)] screen flex flex-col flex-1 gap-8 bg-background rounded-b-xl lg:rounded-bl-none">
			<div className="flex flex-col gap-4 p-6 lg:p-12 pb-4">
				<div className="w-full flex items-center justify-between">
					<h1 className="text-3xl lg:text-4xl font-bold tracking-tight truncate">Input</h1>
					...
					<TabsContents className="w-full pt-2">
						...
						>
							...
							<div className="w-full flex flex-col gap-2">
								...
								<CodeBlock
									data={inputComponentCode}
									defaultValue={inputComponentCode[0].filename}
								>
									<CodeBlockHeader>
										<CodeBlockFiles>
											{(item) => (
