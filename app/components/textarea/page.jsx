...
const commands = [
	{
		label: "pnpm",
		code: "pnpm dlx shadcn@latest add @optics/textarea",
	},
	{
		label: "npm",
		code: "npx shadcn@latest add @optics/textarea",
	},
	{
		label: "yarn",
		code: "yarn shadcn@latest add @optics/textarea",
	},
	{
		label: "bun",
		code: "bunx --bun shadcn@latest add @optics/textarea",
	},
];
		...
		<main className="min-h-[calc(100vh-128px)] screen flex flex-col flex-1 gap-8 bg-background rounded-b-xl lg:rounded-bl-none">
			<div className="flex flex-col gap-4 p-6 lg:p-12 pb-4">
				<div className="w-full flex items-center justify-between">
					<h1 className="text-3xl lg:text-4xl font-bold tracking-tight truncate">Textarea</h1>
			...
			<div className="flex flex-col flex-1 gap-8 p-6 lg:p-12 pt-4">
				<Card className="pt-8 pb-0 bg-sidebar">
					<CardContent className="px-8 w-full flex flex-col items-center justify-center gap-4">
					...
					<TabsContents className="w-full pt-2">
						...
						>
							...
							<div className="w-full flex flex-col gap-2">
								...
								<CodeBlock
									data={textareaComponentCode}
									defaultValue={textareaComponentCode[0].filename}
								>
									<CodeBlockHeader>
										<CodeBlockFiles>
											{(item) => (
					...
					>
						...
						<GridRow>
							...
							<GridItem span={8} className="text-xs font-mono justify-start">
								string (inherits button variant styles)
							</GridItem>
						</GridRow>
					</GridContainer>
				</div>
