...
const code = [
	{
		...
		code: `import { Calendar } from "@/registry/agusmayol/calendar";
				...
				<div className="w-full flex flex-col gap-2">
					...
					>
						...
						<GridRow>
							...
							<GridItem span={8} className="text-xs font-mono justify-start">
								"label" | "dropdown" | "dropdown-months" | "dropdown-years" (default: "label")
							</GridItem>
						</GridRow>
						<GridRow>
							<GridItem
