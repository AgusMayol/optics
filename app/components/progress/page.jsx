...
import { Progress } from "@/registry/agusmayol/progress";
...
const code = [
	{
		...
		code: `import { Progress } from "@/registry/agusmayol/progress";
...
const commands = [
	{
		label: "pnpm",
		code: "pnpm dlx shadcn@latest add @optics/progress",
	},
	{
		label: "npm",
		code: "npx shadcn@latest add @optics/progress",
	},
	{
		label: "yarn",
		code: "yarn shadcn@latest add @optics/progress",
	},
	{
		label: "bun",
		code: "bunx --bun shadcn@latest add @optics/progress",
	},
];
					...
					<TabsContents className="w-full pt-2">
						...
						>
							<div className="w-full flex flex-col gap-2">
								...
								<CodeBlock
									data={progressComponentCode}
									defaultValue={progressComponentCode[0].filename}
								>
									<CodeBlockHeader>
										<CodeBlockCopyButton
											variant="ghost"
