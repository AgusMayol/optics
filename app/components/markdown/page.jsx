		...
		<main className="min-h-[calc(100vh-128px)] screen flex flex-col flex-1 gap-8 bg-background rounded-b-3xl lg:rounded-bl-none">
			<div className="flex flex-col gap-4 p-6 lg:p-12 pb-4">
				...
				<p className="text-muted-foreground text-base lg:text-xl text-pretty">
					A comprehensive Markdown renderer with support for GFM, syntax
					highlighting, and custom components.
				</p>
			</div>
					...
					<CardContent className="px-8 flex items-center justify-center gap-4">
						<div className="prose dark:prose-invert max-w-none">
							<p className="text-muted-foreground text-sm">
								This component renders Markdown content with full GFM support
								including tables, task lists, and more.
							</p>
						</div>
					</CardContent>
