...
const commands = [
	{
		label: "pnpm",
		code: "pnpm dlx shadcn@latest add @optics/badge",
	},
	{
		label: "npm",
		code: "npx shadcn@latest add @optics/badge",
	},
	{
		label: "yarn",
		code: "yarn shadcn@latest add @optics/badge",
	},
	{
		label: "bun",
		code: "bunx --bun shadcn@latest add @optics/badge",
	},
];
					...
					<TabsContents className="w-full pt-2">
						...
						>
							...
							<div className="w-full flex flex-col gap-2">
								...
								<CodeBlock
									data={badgeComponentCode}
									defaultValue={badgeComponentCode[0].filename}
								>
									<CodeBlockHeader>
										<CodeBlockFiles>
											{(item) => (
					...
					data={[
						{
							...
							props: [
								...
								},
								{
									...
									description: "The visual style variant of the badge. Defaults to 'default'.",
								},
								{
									name: "asChild",
									type: "boolean (default: false)",
									description: "When true, the badge will render as its child element instead of a span. Defaults to false.",
								},
							],
						},
					]}
