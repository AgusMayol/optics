...
const code = [
	{
		language: "jsx",
		filename: "label.jsx",
		code: `import { Label } from "@/registry/agusmayol/label";
import { Input } from "@/registry/agusmayol/input";
...
const commands = [
	{
		label: "pnpm",
		code: "pnpm dlx shadcn@latest add @optics/label",
	},
	{
		label: "npm",
		code: "npx shadcn@latest add @optics/label",
	},
	{
		label: "yarn",
		code: "yarn shadcn@latest add @optics/label",
	},
	{
		label: "bun",
		code: "bunx --bun shadcn@latest add @optics/label",
	},
];
					...
					<TabsContents className="w-full pt-2">
						...
						<TabsContent value="tab2" className="w-full pt-4 flex flex-col gap-12">
							...
							<div className="w-full flex flex-col gap-2">
								...
								<CodeBlock
									data={labelComponentCode}
									defaultValue={labelComponentCode[0].filename}
								>
									<CodeBlockHeader>
										<CodeBlockFiles>
											{(item) => (
				...
				<div className="w-full flex flex-col gap-2">
					...
					<div className="w-full p-4 border rounded-xl bg-muted">
						<p className="text-sm text-muted-foreground">
							No specific props. Accepts standard HTML label attributes including <code className="text-xs bg-background px-1 py-0.5 rounded">htmlFor</code>.
						</p>
					</div>
				</div>
			</div>
