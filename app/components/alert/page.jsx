...
import { Alert, AlertTitle, AlertDescription } from "@/registry/agusmayol/alert";
...
const code = [
	{
		language: "jsx",
		filename: "alert.jsx",
		code: `import { Alert, AlertTitle, AlertDescription } from "@/registry/agusmayol/alert";
...
const commands = [
	{
		label: "pnpm",
		code: "pnpm dlx shadcn@latest add @optics/alert",
	},
	{
		label: "npm",
		code: "npx shadcn@latest add @optics/alert",
	},
	{
		label: "yarn",
		code: "yarn shadcn@latest add @optics/alert",
	},
	{
		label: "bun",
		code: "bunx --bun shadcn@latest add @optics/alert",
	},
];
...
const installDeps = [
	{
		label: "pnpm",
		code: "pnpm add class-variance-authority",
	},
	{
		label: "npm",
	...
	{
		label: "yarn",
		code: "yarn add class-variance-authority",
	},
	{
		label: "bun",
		code: "bun add class-variance-authority",
	},
];
		...
		<main className="min-h-[calc(100vh-128px)] screen flex flex-col flex-1 gap-8 bg-background rounded-b-xl lg:rounded-bl-none">
			<div className="flex flex-col gap-4 p-6 lg:p-12 pb-4">
				<div className="w-full flex items-center justify-between">
					<h1 className="text-3xl lg:text-4xl font-bold tracking-tight truncate">Alert</h1>
					...
					<TabsContents className="w-full pt-2">
						...
						<TabsContent value="tab2" className="w-full pt-4 flex flex-col gap-12">
							...
							<div className="w-full flex flex-col gap-2">
								...
								<CodeBlock
									data={alertComponentCode}
									defaultValue={alertComponentCode[0].filename}
								>
									<CodeBlockHeader>
										<CodeBlockFiles>
											{(item) => (
