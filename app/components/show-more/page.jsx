				...
				<Card className="pt-8 pb-0 bg-sidebar">
					<CardContent className="px-8">
						<p className="text-base font-normal">
							...
							quisquam assumenda eligendi provident magni error voluptatibus
							obcaecati ab qui necessitatibus.
						</p>
						{/* Component */}
						<Accordion
							type={"single"}
									...
									<div className="w-full">
										...
										<div className="w-full -mt-4.5 flex items-center justify-center">
											...
											>
												...
												<ChevronDown
													className={cn(
														"text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-300",
