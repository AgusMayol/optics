...
const commands = [
	{
		label: "pnpm",
		code: "pnpm dlx shadcn@latest add @optics/command",
	},
	{
		label: "npm",
		code: "npx shadcn@latest add @optics/command",
	},
	{
		label: "yarn",
		code: "yarn shadcn@latest add @optics/command",
	},
	{
		label: "bun",
		code: "bunx --bun shadcn@latest add @optics/command",
	},
];
					...
					<TabsContents className="w-full pt-2">
						...
						>
							<div className="w-full flex flex-col gap-2">
								...
								<CodeBlock
									data={commandComponentCode}
									defaultValue={commandComponentCode[0].filename}
								>
									<CodeBlockHeader>
										<CodeBlockCopyButton
											variant="ghost"
