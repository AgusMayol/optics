		...
		<main className="min-h-[calc(100vh-128px)] screen flex flex-col flex-1 gap-8 bg-background rounded-b-xl lg:rounded-bl-none">
			<div className="flex flex-col gap-4 p-6 lg:p-12 pb-4">
				<div className="w-full flex items-center justify-between">
					<h1 className="text-3xl lg:text-4xl font-bold tracking-tight truncate">Code Block</h1>
				</div>
						...
						>
							...
							<div className="w-full flex flex-col gap-2">
								...
								<Button variant="link" size="sm" asChild className="w-fit">
									<Link
										href="https://github.com/agusmayol/optics/blob/main/registry/agusmayol/code-block.tsx"
										target="_blank"
