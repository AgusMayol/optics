		...
		<main className="flex flex-col flex-1 gap-8 bg-background">
			<div className="flex flex-col gap-4 p-12">
				...
				<p className="text-muted-foreground text-xl">
					Tailwind variables are a way to customize the look and feel of your
					website.
				</p>
			</div>
			...
			<div className="px-12 flex items-center justify-center">
				...
				>
					<CodeBlockHeader className="border-0 absolute top-0 right-0 z-10 group-hover:opacity-100 opacity-0 transition-opacity duration-150 ease-in-out bg-transparent">
						<CodeBlockCopyButton
