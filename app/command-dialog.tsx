...
type CommandDialogLinkItem = {
	name: string;
	href: string;
	disabled?: boolean;
};

type CommandDialogLinkGroup = {
	name: string;
	items: CommandDialogLinkItem[];
};

type CommandDialogComponentProps = {
	links: CommandDialogLinkGroup[];
	className?: string;
};
